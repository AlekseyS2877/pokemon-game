...
function App() {
   ...
   return (
      <>
         <Header title="Покемоны" descr="Карточная игра" />
         <Layout title="Правила" urlBg={bgImg1}>
            In the game two players face off against one another, one side playing as
            &quot;blue&quot;, the other as &quot;red&quot; on a 3x3 grid. Each player has five cards
            in a hand and the aim is to capture the opponent&apos;s cards by turning them into the
            player&apos;s own color of red or blue.
         </Layout>
         <Layout title="Карточки" colorBg={bgColor}>
         ...
         <Layout title="Подробнее об игре" urlBg={bgImg2}>
            ...
            &quot;ranks&quot; of the sides where the two cards touch will be compared. If the rank
